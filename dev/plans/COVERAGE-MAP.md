...
- `field_analytes_diff_required` pinned default → "R-1.1: field_analytes_diff_required default is the pinned TSS set"
- list-key env-var guard covers the new key → "R-12.11: field_analytes_diff_required is guarded as list-valued too"
...
- diff-required labels never import on name (A75/A76) → "R-6.6: a diff-required label is never imported on its name alone"
